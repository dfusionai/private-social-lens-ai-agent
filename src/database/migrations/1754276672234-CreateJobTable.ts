...
export class CreateJobTable1754276672234 implements MigrationInterface {
  name = 'CreateJobTable1754276672234';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "job" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "type" character varying(50) NOT NULL DEFAULT 'data-refinement', "status" character varying(20) NOT NULL DEFAULT 'pending', "blobId" character varying(255) NOT NULL, "onchainFileId" character varying(255) NOT NULL, "policyId" character varying(255) NOT NULL, "processingOptions" jsonb, "resultData" jsonb, "errorMessage" text, "workerId" character varying(100), "attempts" integer NOT NULL DEFAULT '0', "maxAttempts" integer NOT NULL DEFAULT '3', "pgBossJobId" character varying(100), "startedAt" TIMESTAMP, "completedAt" TIMESTAMP, "failedAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "userId" integer NOT NULL, CONSTRAINT "PK_98ab1c14ff8d1cf80d18703b92f" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
